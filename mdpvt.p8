...
function workers_update()
 for worker in all(workers) do
  ...
  if worker.hands then
   if not worker.dead then
    -- special attack lasts 240 frames
    -- pincer attacks lasts 240 frames
    if frame%480 < 240 then
     ...
     for h = 1,2 do
      ...
      elseif fr < 30 then
       ...
       worker.hands[h].x = worker.x+1+128*sin((fr-30)/210+0.5*h)
      end
     end
     -- hop
     if fr > 90 and worker.ground then
      worker.vy -= 3
     end
    else
     fr = frame%120
    ...
    objapplygravity(worker.hands[1])
    objapplygravity(worker.hands[2])
   end
   objmovecheap(worker.hands[1])
   objmovecheap(worker.hands[2])
  end
...

...
10008400840000000000000000000000100000000000001000000000101000102050000000000000000000000000505050000000000000000000000000502010
...

