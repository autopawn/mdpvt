 ...
 for x = 0,127 do
  for y = 0,63 do
   ...
   if fget(t, 5) then
    local cols = {}
    for _ = 1,8 do
     add(cols, sget(t%16*8+rnd(8), t\16*8+rnd(8)))
    end
...
function brick_break(brick)
 if level >= break_bricks_level then
  add_blood(brick.x+4,brick.y+4, brick.cols, rnd(6)+4, rnd({30,35,40,45}))
...

...

...
900000000000000000000000000000560000000000000000000000001000000000000010909000000000000000000000000000000000d1000000000000100010
...

...
__gff__

