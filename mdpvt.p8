...
dialog_bonus_1 = {
 ...
 "congrats!",
 "while we finish up your",
 "training please emjoy",
 "these 3 bonus trials.",
 "these trials are not",
 "levels and should simply",
 "be viewed as extra",
 "challenges.",
 "any feedback you leave",
 "would be appreciated.",
 "...",
 "first up is a new enemy",
 "for you to face, along",
 "with a new upgrade!",
 "for these trials your",
 "rockets and slams will",
 "have the ability to",
 "break cracked tiles.",
 "you'll have to use",
 "both weapons to beat",
 "this trial. good luck!",
}
